...
public interface StudentOperations extends Remote {
	String bookRoom(String user_id, String campus_name, int room_number, DateReservation date, TimeSlot time_slot) throws RemoteException, NotBoundException, IOException;
	ArrayList<TimeSlotResult> getAvailableTimeSlot(DateReservation date) throws RemoteException;
	boolean cancelBooking(String user_id, String bookingID) throws RemoteException;
}
